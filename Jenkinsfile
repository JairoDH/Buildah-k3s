...
'''
    ...
    stages {
        ...
        stage('Deployment') {
			...
			sh "ssh -o StrictHostKeyChecking=no jairo@fekir.touristmap.es 'rsync -avz --delete 192.168.122.33:/home/jairo/Keptn-k3s/wordpress/ /home/jairo/Keptn-k3s/wordpress/'"
